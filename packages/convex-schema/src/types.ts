...
export type ProductSource = 'manual' | 'uber_eats' | 'deliveroo' | 'ai-image'
...
// ============================================================================
// IMAGE TO PRODUCT TYPES
// ============================================================================

/** Source of an AI-generated field value */
export type AiFieldSource = "detected" | "generated" | "inferred"

/** Wraps a field value with AI metadata (source + confidence) */
...
/** Warning emitted during image parsing */
...
/** Analysis mode: single dish photo or full menu photo */
export type ImageToProductMode = "single" | "menu"

/** Source of the product image */
export type ImageSource = "uploaded" | "generated"

/** A product suggestion generated by AI, before admin validation */
...
/** Result returned by the imageToProduct.analyze action */
export type AnalyzeImageResult = {
  mode: ImageToProductMode
