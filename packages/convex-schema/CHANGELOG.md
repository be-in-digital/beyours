# Changelog - @be-yours/convex-schema

## 1.0.0

### Major Changes

- Renamed from `@be-in-digital/convex-schema` to `@be-yours/convex-schema`, and reset to 1.0.0.
  ...
  from `6.9.0`. The old scope keeps everything it published: those
