...
// Prefix visibility lives in its own SDK-free module so Convex can import it
// without pulling in the rest of the package. Re-exported here so existing
// `@be-in-digital/core` consumers keep working.
export {
  PUBLIC_S3_FOLDERS,
  PRIVATE_S3_FOLDERS,
  S3_FOLDERS,
...
export type { PublicS3Folder, PrivateS3Folder, S3Folder } from './prefixes'

import type { S3Folder } from './prefixes'
