...
- Renamed from `@be-in-digital/ui` to `@be-yours/ui`, and reset to 1.0.0.
  ...
  from `4.3.3`. The old scope keeps everything it published: those
...
- 9b0b850: Read a selector list as one rule, so a template's palette can be measured
...
- 82e410f: Measure the colours a `styles={{ slot: … }}` map paints
