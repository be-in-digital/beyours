...
|---|---|---|---|
| **GitHub** | org `be-yours`, private Packages `@be-yours/*` | `NODE_AUTH_TOKEN` | Needs a `read:packages` PAT. Actions budget must stay funded — it hit zero on 2026-08-16 and every workflow died. |
