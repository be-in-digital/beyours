                ...
                <div className="bg-[#0D5C3F] rounded-[3rem] md:rounded-[4rem] p-10 md:p-16 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
                            ...
                            />
                            <Button className="h-14 px-8 rounded-2xl bg-orange-500 hover:bg-orange-600 text-white font-black uppercase tracking-widest text-xs shadow-xl shadow-orange-500/20">
                                S&apos;inscrire
                            </Button>
                        </div>
                    </div>
