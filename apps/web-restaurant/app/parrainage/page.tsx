      ...
      <div className="text-center mb-16">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center h-12 px-8 rounded-xl bg-white/[0.04] border border-white/[0.08] text-foreground font-medium hover:bg-white/[0.08] transition-colors"
          >
            J&apos;ai déjà un compte
          </Link>
        </div>
