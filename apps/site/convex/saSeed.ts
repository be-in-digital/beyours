...
async function seedIncidents(
  ...
  const specs: Spec[] = [
    ...
    { email: "sophie@comptoirdore.fr", title: "Imprimante cuisine hors-ligne", severity: "sev3", status: "resolved", area: ["kitchen"], detectedBy: "client", startedAgo: 3 * DAY, resolvedAgo: 3 * DAY - 5 * 3_600_000, assignee: "Camille Renaud", impact: "Tickets non imprimés sur une station.", updates: [ { ago: 3 * DAY, status: "open", message: "Imprimante ESC/POS injoignable." }, { ago: 3 * DAY - 5 * 3_600_000, status: "resolved", message: "IP fixée en DHCP statique. Impression OK.", by: "Camille Renaud" } ] },
